...
<script type="text/javascript">
    function printError(elemId, error) {
		...
		$(document).ready(function(e){
			$("#Login").on("click",function(e)
			{
                ...
                var email=$("#email").val();
                var usernameErr = lastnameErr= firstnameErr= passwordErr= phonenumberErr=emailErr= true;
    ...
    if(phonenumber == "") {
     ...
     if(email == "")
     {
        ...
        if(usernameErr || lastnameErr|| firstnameErr|| passwordErr|| phonenumberErr||emailErr === true)
    {  
        return false;
    }
    else{
        ...
        $.ajax({
				url:"T_register_process.php",
				type: "POST",
				data: {username:username, password:password, firstname:firstname, lastname:lastname, phonenumber:phonenumber, email:email, submit:"submit"},
