	...
	if (isset($_POST['submit']))
	 {
        ...
        $query1="SELECT * FROM math where Term='$term' and Years='$years' and Class='$Class_A' and Roll_Number='$RollNumber'  ";
        $query2="SELECT * FROM physic where Term='$term' and Years='$years' and Class='$Class_A' and Roll_Number='$RollNumber'  ";
        $query3="SELECT * FROM chemistry where Term='$term' and Years='$years' and Class='$Class_A' and Roll_Number='$RollNumber'  ";
        $query4="SELECT * FROM dccn where Term='$term' and Years='$years' and Class='$Class_A' and Roll_Number='$RollNumber'  ";
        $query5="SELECT * FROM wdd where Term='$term' and Years='$years' and Class='$Class_A' and Roll_Number='$RollNumber'  ";
        $query6="SELECT * FROM nepali where Term='$term' and Years='$years' and Class='$Class_A' and Roll_Number='$RollNumber'  ";
