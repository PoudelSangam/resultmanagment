<?php
	...
	include("teacher_registation_ajax.php");
?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
	<title>Teacher Registation</title>
  <link rel="stylesheet" type="text/css" href="css/homepage.css">
  <link rel="stylesheet" type="text/css" href="css/register.css">
  <link rel="stylesheet" type="text/css" href="css/Errormsg.css">

  <!-- <script src="T_register_valid.js"></script> -->
</head>
...
<div class="navigation">
  <ul>
	...
	<li class="active"><a href="teacher registation.php">TEACHER REGISTATION</a></li>
...
<div style="margin-top: 70px; ">
	...
	<form name="Form" id="form" >
		...
		<div><input class="button" type="submit" name="submit" value="register" id="Login"></div>
	</form>
